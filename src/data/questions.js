const questions = [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        key: 'E',
        answer: 'ขึ้นอยู่กับว่ารีบมั้ย ถ้ารีบ ดูแล้วไม่มีรถ ปลอดภัย ก็ข้ามเลย',
      },
      {
        key: 'F',
        answer:
          'แอบคิดนะ ว่าไฟเขียวแดงเนี่ย เคยมั้ยที่ทุกฝั่งขึ้นไฟแดงพร้อมกันหมดเลย',
      },
    ],
  },
  {
    question: 'เสาร์นี้เพื่อนเก่ามัธยมปลายนัดกันไปดูหนัง ถ้างั้นเราก็..',
    answers: [
      {
        key: 'G',
  ...
  },
  {
    ...
    answers: [
      ...
      {
        key: 'L',
        answer: 'ในการทำงานผลประโยชน์ของลูกค้าสำคัญที่สุด',
      },
      {
        key: 'M',
        answer:
          'ไม่มีวิธีแก้ปัญหาที่ถูกหรือผิด มีแต่ว่าวิธีการนั้นแก้ปัญหาได้ดีแค่ไหน',
      },
      {
        key: 'N',
  ...
  },
  {
    ...
    answers: [
      ...
      {
        key: 'X',
        answer: 'โทรไปบอกที่ร้านว่าไปน่าเข้าไปทันวันนี้ ทำยังไงดีฮะ',
      },
    ],
  },
];
